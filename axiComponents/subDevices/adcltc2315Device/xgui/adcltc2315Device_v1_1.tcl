...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "sclk_frequency"
...
proc update_PARAM_VALUE.unique_id { PARAM_VALUE.unique_id PARAM_VALUE.unique_id } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.unique_id}] ${PARAM_VALUE.unique_id}
}
