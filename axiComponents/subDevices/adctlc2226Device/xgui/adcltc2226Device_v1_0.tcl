...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "sample_clk"
...
proc update_PARAM_VALUE.sample_clk { PARAM_VALUE.sample_clk } {
	# Procedure called to update sample_clk when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.sample_clk { PARAM_VALUE.sample_clk } {
	# Procedure called to validate sample_clk
	return true
}
...
proc update_MODELPARAM_VALUE.sample_clk { MODELPARAM_VALUE.sample_clk PARAM_VALUE.sample_clk } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.sample_clk}] ${MODELPARAM_VALUE.sample_clk}
}
